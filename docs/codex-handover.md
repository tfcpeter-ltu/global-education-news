...
更新日期：2026-09-15（Asia/Taipei）。使用者已明確授權 Codex 接手本專案網站維護、新聞與獎學金上稿及部署驗收。最新每日社群範圍為 FB／IG／Threads，各發一篇新聞與一則獎學金，共六則自然貼文；X 保留備用文案。
...
| Threads | @ltuossdtw；每日必發兩則，已於 2026-09-15 直接登入介面發布並回讀成功 |
