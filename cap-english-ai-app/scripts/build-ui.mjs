...
const cache='20260909-cute-hero-v7-inline';
...
// Hero is embedded into JavaScript at build time so production never depends on a separate image URL.
...
console.log('CAP English AI built: hero embedded as data URI + correct hero target + cache v7');
