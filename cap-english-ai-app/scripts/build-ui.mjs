...
const cache='20260908-product-core-v2';
...
for(const asset of ['ltu-refine-v3.js','ltu-refine-v4.js','remove-hero.js','question-engine-v2.js','practice-ui-v4.js','notebook-ui-v1.js','product-core-v1.js']){
...
console.log('CAP English AI built: product core v1, 20k unique generator, strict Free 3, Complete learning loop');
