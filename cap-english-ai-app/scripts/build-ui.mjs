...
const cache='20260913-feature-v21-tradtw';
...
if(feature.length<50000 || feature.subarray(4,12).toString('ascii')!=='ftypavif') throw new Error(`Invalid feature AVIF: ${feature.length} bytes / ${feature.subarray(4,12).toString('ascii')}`);
await writeFile('public/cap-feature-hero-v21.avif',feature);
...
console.log(`CAP English AI built: Traditional Chinese UI + feature AVIF ${feature.length} bytes + ${cache}`);
