...
const cache='20260909-cute-hero-v9-inner-doc';
...
for(const file of files){
  ...
  console.log('copied and injected hero into',file);
}
...
console.log('CAP English AI built: hero injected inside final-v3 document + cache v9');
