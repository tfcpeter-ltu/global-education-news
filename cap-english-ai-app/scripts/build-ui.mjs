...
const cache='20260914-game-v7-detached';
...
if(mainHero.length<30000 || mainHero.subarray(0,4).toString('ascii')!=='RIFF' || mainHero.subarray(8,12).toString('ascii')!=='WEBP') throw new Error('Invalid main hero');
