...
const cache='20260908-launch-clean-v8';
...
for(const asset of ['ltu-refine-v3.js','ltu-refine-v4.js','remove-hero.js','question-engine-v2.js','practice-ui-v4.js','notebook-ui-v2.js','auth-ui-v2.js','product-core-v1.js','launch-ui-v1.js','membership-sync-v1.js']){
...
console.log('CAP English AI built: launch clean v8, real auth/payment, no legacy student flow');
