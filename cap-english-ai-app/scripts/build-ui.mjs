...
const cache='20260909-cute-hero-v3';
...
const heroB64=(await readFile('cap-hero-cute.b64','utf8')).trim();
await writeFile('public/cap-hero-cute.jpg',Buffer.from(heroB64,'base64'));
...
console.log('CAP English AI built: cute hero + cute visual theme + single membership section');
